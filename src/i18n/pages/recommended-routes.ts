...
export const recommendedRoutes = {
	...
	ru: {
		seoTitle: 'Лучшие маршруты на лодке по Закинфу (Занте) | Навайо и Голубые пещеры',
		seoDescription:
			'Откройте для себя лучшие маршруты на лодке по Закинфу. Посетите пляж Кораблекрушения (Навайо), Голубые пещеры, пещеры Кери, Черепаший остров и укромные уголки. Рекомендуемые маршруты для самостоятельного управления и прогулок со шкипером.',
		heroAria: 'Рекомендуемые маршруты',
		heroLabel: 'ИССЛЕДУЙТЕ ЗАКИНФ',
		heroTitle: 'Рекомендуемые маршруты',
		heroSubtitle:
			'Откройте для себя лучшие места вокруг Закинфа на лодке. От знаковых достопримечательностей до укромных уголков.',
		routesAria: 'Маршруты',
		cardCta: 'Забронировать этот маршрут',
		contactAria: 'Контакты',
		ctaTitle: 'Не уверены, какой маршрут выбрать?',
		ctaDesc:
			'Свяжитесь с нами, и мы поможем спланировать идеальную поездку с учётом ваших предпочтений, размера группы и доступного времени.',
		ctaBtnPrimary: 'Свяжитесь с нами',
		ctaBtnCall: 'Звоните: 0030 698 793 1327',
	},
	el: {
		seoTitle: 'Καλύτερες διαδρομές με σκάφος στη Ζάκυνθο | Ναυάγιο & Γαλάζιες Σπηλιές',
		seoDescription:
			'Ανακαλύψτε τις καλύτερες διαδρομές με σκάφος στη Ζάκυνθο. Επισκεφθείτε την παραλία του Ναυαγίου, τις Γαλάζιες Σπηλιές, τις Σπηλιές Κερί, το Νησί της Χελώνας και κρυμμένους θησαυρούς. Προτεινόμενες διαδρομές για ενοικίαση χωρίς δίπλωμα και κρουαζιέρες με σκίπερ.',
		heroAria: 'Προτεινόμενες διαδρομές',
		heroLabel: 'ΕΞΕΡΕΥΝΗΣΤΕ ΤΗ ΖΑΚΥΝΘΟ',
		heroTitle: 'Προτεινόμενες διαδρομές',
		heroSubtitle:
			'Ανακαλύψτε με σκάφος τους καλύτερους προορισμούς γύρω από τη Ζάκυνθο. Από εμβληματικά αξιοθέατα έως κρυμμένους θησαυρούς.',
		routesAria: 'Διαδρομές',
		cardCta: 'Κλείστε αυτή τη διαδρομή',
		contactAria: 'Επικοινωνία',
		ctaTitle: 'Δεν είστε σίγουροι ποια διαδρομή να επιλέξετε;',
		ctaDesc:
			'Επικοινωνήστε μαζί μας και θα σας βοηθήσουμε να σχεδιάσετε την ιδανική εκδρομή με βάση τις προτιμήσεις σας, το μέγεθος της παρέας σας και τον διαθέσιμο χρόνο.',
		ctaBtnPrimary: 'Επικοινωνήστε μαζί μας',
		ctaBtnCall: 'Καλέστε: 0030 698 793 1327',
	},
